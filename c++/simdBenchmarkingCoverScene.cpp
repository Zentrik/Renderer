...
void random_scene(hittable_list& world) {
    ...
    world.add(sphere(point3(0, -1000, 0), 1000, nullptr));
        ...
        for (int b = -11; b < 11; b++) {
            ...
            if (length(center - point3(4, 0.2, 0)) > 0.9) {
                if (choose_mat < 0.8) {
                    ...
                    world.add(sphere(center, 0.2, nullptr));
                }
    ...
    world.add(sphere(point3(0, 1, 0), 1.0, nullptr));

    world.add(sphere(point3(-4, 1, 0), 1.0, nullptr));
